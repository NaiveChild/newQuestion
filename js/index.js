$(function() {
    ...
    function GetResultImage() {
        ...
        document.getElementById("maincanvas").width = 750;
        document.getElementById("maincanvas").height = 1206;
        ...
        starImg.onload = function () {
            ...
            mainCtx.font = "normal normal normal 20px qianming";
            mainCtx.fillStyle = "black";
            // mainCtx.fillText(UName, x, y);
            mainCtx.fillText(UName, 580, 1130);
            var image = document.getElementById("maincanvas").toDataURL("image/jpg").replace("image/jpg", "image/octet-stream");

            document.getElementById("maincanvas").style.display = "none";
            document.getElementById("resultImg").src = image;
